...
the hydrostatic deformation of the CB droplet upon mechanical stress,
...
\end{eqnarray}
 ...
 that linearly increases with owing to the intrinsically identical
 ...
 NW) (details see Supplementary Table S2).  We point out that the
 ...
 is given by:
  ...
  (Supplementary Fig. S21), together with the detection limit of down
  ...
  reasonably well (Supplementary Fig. S21). The above analysis is
...
* Acknowledgments
  ...
  Processes (SCCER-EIP) program (grant no. KTI.2014.0148) Ms. Asel
