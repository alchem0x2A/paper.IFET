...
an increase of penetration length $\Delta l \approx \varepsilon
...
#+END_COMMENT
 ...
 constant independent of \varepsilon, the cross-sectional boundary of
 ...
 Fig. S23). First, the maximum height $H_{0}$ corresponding to $\varepsilon=0$
 is given by:
  ...
  contact area $\Delta A$ upon stress $\varepsilon$, and the change of
