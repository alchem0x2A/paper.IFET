...
\thanks{Present address: Department of Mechanical Engineering, Indian Institute of Technology Ropar, Rupnagar, Punjab 140001, India}
...
\thanks{Present address: Department of Chemical and Biomolecular Engineering, University of California, Berkeley, CA 94720, USA}
\affiliation{Institute for Chemical and Bioengineering, ETH Z{\"{u}}rich,  Vladimir-Prelog Weg 1, CH-8093 Z{\"{u}}rich, Switzerland}
\author{Yen-Ting Lee}
...
\thanks{Correspondence should be addressed to C.J.S. chih-jen.shih@chem.ethz.ch}
\affiliation{Institute for Chemical and Bioengineering, ETH Z{\"{u}}rich,  Vladimir-Prelog Weg 1, CH-8093 Z{\"{u}}rich, Switzerland}
#+END_EXPORT
...
\end{eqnarray}
 ...
 is given by:
  ...
  of 0.036 Pa\(^{-1}\) (Supplementary Figure S21), together with the
  ...
  Figure [[ref:fig:main-1]]b) is negligible within the stress range
  ...
  Figure S21). The above analysis is further endorsed by the finite
  element method (FEM) simulations (Figure  [[ref:fig:main-4]]d,
  ...
  (Figure [[ref:fig:main-4]]e, Supplementary Movie S3). It is also
  noteworthy that the EGaIn sessile droplets function equally well on
  the NWs (Supplementary Figure S18), in spite of their sticky oxide
  surface.
