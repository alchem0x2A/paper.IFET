...
different approach concept to address the challenge, inspired by
the liquid-repellent behaviour of a sessile droplet interacting with a
...
(2DEG) and a conductive Cassie-Baxter (CB) sessile droplet. The CB
droplet in the IFET exhibits ultra-low elastic modulus below 1 kPa,
enabling a large vertical elastic displacement over 13.5% together
with an excellent stress sensitivity down below 10 Pa. With carrier
density and Schottky barrier at the NW/2DEG interface modulated by
partially-penetrated electrostatic field, the IFET shows an on/off
current ratio exceeding 3\(\times\)10^{4}, which can be tuned by
temperature. Our concept of IFET demonstrates a versatile platform
that bridges multiple macroscopic interfacial phenomena with
...
the semiconductor-S and semiconductor-D interfaces maximizes the
response to the interfacial properties. 
*************** TODO To be safer, I removed the Debye length part since the Debye length for organic semiconductor in literature is typically very small (less than 20 nm).
*************** END
...
thermodynamically favoured. The structural driving force resulting from
...
additional peaks corresponding to the (002) plane (labeled as
...
thin-film F_{16}CuPc/SiO_{2} surface is found to be hydrophobic with an
equilibrium sessile droplet contact angle of 103.0\(\pm\)5.4\(^{\circ}\) and
ESEM contact angle of 107.0\(\pm\)3.9\(^{\circ}\), as normally observed for
such non-structured fluorine-rich molecules. On the other hand, the
F_{16}CuPc/Gr NWs surface shows much higher equilibrium sessile and
ESEM contact angles of 152.8\(\pm\)3.9\(^{\circ}\) and 149.8\(\pm\)3.4\(^{\circ}\),
respectively. The great distinction between the wettability can be
briefly explained by the different between the Wenzel wetting state on
rough planar surface (F_{16}CuPc/SiO_{2}) and the Cassie-Baxter
wetting state on high aspect ratio surface (F_{16}CuPc/Gr). The
equilibrium contact angles of the two wetting states
($\theta^{*}_{\mathrm{s,W}}$ and $\theta^{*}_{\mathrm{s,CB}}$) are
...
\end{eqnarray}
 ...
 where $r_{\mathrm{W}}$ and $r_{\mathrm{CB}}$ are the surface
 ...
 F_{16}CuPc/Gr surfaces, we get \(f\)=0.093, indicating a minor
 ...
 surface exhibits a much smaller $\theta_{\mathrm{sl}}^{*}$ of 14.6\(\pm\)
 2.6\(^{\circ}\). The superior wetting properties of LM on the
 superhydrophobic NW surfaces indicates that our concept of
 ...
 elastic IFET. A sheet of monolayer graphene grown by chemical vapour
 deposition (CVD) was transferred onto a SiO_{2}/Si substrate
 ...
 traps.  The CVD graphene has a sheet resistance tunable by the gate with an
 on/off ratio of \sim10 and a field-effect mobility
 (\(\mu_{\mathrm{FE}}\)) of \sim2000 cm^{2}V^{-1}s^{-1} at room
 temperature, with the charge neutrality point (CNP) at the gate
 voltage of \sim0 V (Figure S14). Subsequently, a layer of \sim300
 ...
 facilitates carrier transport along the NW, but also makes the
 ...
 of 5\(\times\)10^{3} (Figure [[ref:fig:main-3]](b) inset). The transfer
 curves at different $V_{\mathrm{D}}$ are shown in Figure
 [[ref:fig:main-3]](c), with the on/off current ratio gradually decreases
 with $V_{\mathrm{D}}$, owing to a mechanism analogous to the
 drain-induced barrier lowering (DIBL) effect in the short-channel
 ...
 concerning the gate-tunability of the F_{16}CuPc/Gr IFET, by
 switching an commercial green LED (Figure [[ref:fig:main-3]](d)) with the
 help of a home-made bipolar junction transistor (BJT) amplifier
 circuit.  We demonstrate that over 10 cycles of on-off switching
 cycles by tuning the $V_{\mathrm{G}}$ from -75 V to 100 V, the total
 current through the circuit can be tuned by 250 folds with
 appreciable stability, showing good and reliable gate tunability.
  ...
  Supporting Information). The value of $H_{0}$ is determined by the
 ...
 Figure [[ref:fig:main-4]](b) shows the experimental and simulated elastic
  ...
  from graphene conductivity tests (details see Supporting
